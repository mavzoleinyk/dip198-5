...
<section class="section skills-posts mt-40 mb-0">
    ...
    <div class="skills-content">
        ...
        <div class="skills-item">
            ...
            <div class="title"><a href="/kupit-diplom-svarschika/">Сварщик</a></div>
        </div>
        <div class="skills-item">
            <div class="image"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/photo/skill-3.jpg" alt="Изготовление дипломов массажиста на заказ недорого"></div>
            <div class="title"><a href="/kupit-diplom-massazhista/">Массажист</a></div>
        </div>
        <div class="skills-item">
            ...
            <div class="title"><a href="/kupit-diplom-povara/">Повар</a></div>
        </div>
        <div class="skills-item">
            ...
            <div class="title"><a href="/kupit-diplom-medsestry/">Медсестра</a></div>
        </div>
        <div class="skills-item">
            ...
            <div class="title"><a href="/kupit-diplom-inzhenera/">Инженер</a></div>
        </div>
        <div class="skills-item">
